...
//        [3,9,20,null,null,15,7]  2
        ...
        a = new A0437PathSumIII().pathSum(root, 0);
...
//        [3,9,20,null,null,15,7]  2
        ...
        a = new A0437PathSumIII().pathSum(root, 12);
        System.out.println("================" + a);
...
//  [1,9]  1
        root = new TreeNode(1);
        root.left = new TreeNode(9);
        a = new A0437PathSumIII().pathSum(root, 10);
        System.out.println("================" + a);
// [1] 1
        root = new TreeNode(1);
        a = new A0437PathSumIII().pathSum(root, 1);
        System.out.println("================" + a);
...
//[5,4,8,11,null,13,4,7,2,null,null,5,1] 3
        ...
        a = new A0437PathSumIII().pathSum(root, 22);
        System.out.println("================" + a);
